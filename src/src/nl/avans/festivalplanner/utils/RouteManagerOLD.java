...
public class RouteManagerOLD implements Serializable
{
	 ...
	 * @author Jordy Sipkema
	 */
	public static RouteManagerOLD instance()
	{
		if (_instance == null)
		{
			_instance = new RouteManagerOLD();
		}
		return _instance;
	}
}
